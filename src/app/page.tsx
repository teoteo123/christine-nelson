    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-36 text-center">
          <FadeIn>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/blog"
                className="px-8 py-3.5 border-2 border-warm-400 text-warm-700 font-medium rounded-full hover:border-accent hover:text-accent transition-colors btn-press"
              >
                Read the Blog
              </Link>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <FadeIn key={title} delay={i * 150}>
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md hover-lift transition-shadow h-full">
      ...
      <section className="bg-warm-900 text-white py-20">
        <FadeIn>
          <div className="max-w-3xl mx-auto px-6 text-center">
            <p className="font-serif text-xl md:text-3xl leading-relaxed italic mb-8">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        <FadeIn>
          ...
          <Link
            href="/contact"
            className="inline-block px-8 py-3.5 bg-accent text-white font-medium rounded-full hover:bg-accent-dark transition-colors btn-press"
          >
            Get in Touch
          </Link>
        </FadeIn>
